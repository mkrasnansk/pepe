  ...
  return (
    <div className="main-page-wrapper">
      ...
      {/* <!-- 
        ...
        ============================================== 
        --> */}
      <div className="vcamp-text-block-one pt-200 md-pt-120 pb-80 dark-bg">
          ...
          <div className="row">
            <div className="col-xxl-7 col-lg-8 m-auto">
              <div className="text-wrapper text-center ps-0">
                ...
                <Link to="/ui-header-v6" className="theme-btn-four ripple-btn">
                  Next Header
                </Link>
              </div>
              {/* End .text-wrapper */}
