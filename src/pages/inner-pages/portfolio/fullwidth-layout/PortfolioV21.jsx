...
import Portfolio20 from "../../../../components/portfolio/Portfolio20";
import Seo from "../../../../components/common/seo/Seo";

const PortfolioV21 = () => {
  return (
    <div className="main-page-wrapper">
      <Seo title="Portfolio V21" />
      ...
      <div className="portfolio-gallery-eight portfolio-gallery-three border-top pt-130 pb-150 lg-pt-80 lg-pb-90">
        <div className="container-fluid">
          <div className="slider-wrapper position-relative box-laout-n">
            <div className="portfolio-slider-two gap15 slick-rounded-arrow arrow-center ripple-btn is_light">
              <Portfolio20 />
            </div>
