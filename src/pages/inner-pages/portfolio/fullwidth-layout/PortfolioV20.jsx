...
import Portfolio19 from "../../../../components/portfolio/Portfolio19";
import Seo from "../../../../components/common/seo/Seo";

const PortfolioV20 = () => {
  return (
    <div className="main-page-wrapper">
      <Seo title="Portfolio V20" />
      ...
      <div className="portfolio-gallery-eight border-top pt-130 pb-150 lg-pt-80 lg-pb-80">
        <div className="container-fluid">
          <div className="slider-wrapper position-relative ">
            <div className="portfolio-slider-two box-laout-n hvr-overlay-right galley-item-wrapper gap15 slick-rounded-arrow arrow-center ripple-btn is_light">
              <Portfolio19 />
            </div>
