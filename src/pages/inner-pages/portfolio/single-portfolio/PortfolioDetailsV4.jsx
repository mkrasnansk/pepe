...
const PortfolioDetailsV4 = () => {
  ...
  return (
    <div className="main-page-wrapper  dark-bg">
      <Seo title="Portfolio Details V4" />
                ...
                <div className="d-flex flex-column">
                  ...
                  <div className="text-wrapper pb-65 lg-pb-50 order-lg-1">
                    ...
                    <a
                      ...
                      className="theme-btn-thirteen"
                      target="_blank"
                    >
                      Live Link <i className="bi bi-chevron-right"></i>
                    </a>
                  </div>
                </div>
              </div>
      ...
      {/* <!--
			...
			=====================================================
			--> */}
      <div className="fancy-banner-seven  dark-bg">
        <div className="container">
          <div className="inner-content position-relative">
            <div className="row align-items-center">
              ...
              <div className="col-xl-4 col-lg-3 text-center text-lg-end">
                <Link
                  to="/contact-v1"
                  className="theme-btn-thirteen ripple-btn"
                >
                  Let’s Discuss
                </Link>
              </div>
            ...
            <div className="col-xl-3 col-lg-2 mb-40">
              <div className="logo">
                <Link to="/">
                  <img
                    src={
                      require("../../../../assets/images/logo/vCamp_04.svg")
                        .default
                    }
                    alt="brand"
                  />
...
export default PortfolioDetailsV4;
