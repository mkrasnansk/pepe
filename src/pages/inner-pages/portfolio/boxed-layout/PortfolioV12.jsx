...
import Portfolio11 from "../../../../components/portfolio/Portfolio11";
import Seo from "../../../../components/common/seo/Seo";

const PortfolioV12 = () => {
  return (
    <div className="main-page-wrapper">
      <Seo title="Portfolio V12" />
      ...
      {/* <!--
			...
			=====================================================
			--> */}
      <div className="portfolio-gallery-three border-top pt-130 pb-150 lg-pt-80 lg-pb-80">
        <div className="container">
          <div className="slider-wrapper position-relative">
            <div className="portfolio-slider-four gap15 slick-rounded-arrow arrow-center ripple-btn is_light">
              <Portfolio11 />
            </div>
