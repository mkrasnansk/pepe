...
import banner from "../../../../assets/images/media/img_62.jpg";
...
const BlogDetailsV2 = () => {
  return (
    <div className="main-page-wrapper">
      ...
      <div className="inside-hero-seven">
        <div
        ...
        >
          <div className="container">
            ...
            <p className="blog-pubish-date">
              Digital Marketing . 2 July . By <a href="#">Rashed Ka</a>
            </p>
          </div>
        </div>
        {/* <!-- /.bg-wrapper --> */}
        <div className="container">
          <nav className="blog-breadcrumb mt-60 md-mt-20">
            <Breadcrumb />
          </nav>
        </div>
      </div>
